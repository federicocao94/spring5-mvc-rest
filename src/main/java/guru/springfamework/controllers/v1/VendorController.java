 ...
 */
@Api(description = "The vendor controller")
@RestController
...
public class VendorController {
    ...
    @ApiOperation(value = "This will get a list of vendors.", notes = "Get all the vendors")
    @GetMapping
    ...
    @ApiOperation(value = "This will get a specific vendor.")
    @GetMapping({"/{id}"})
    @ResponseStatus(HttpStatus.OK)
